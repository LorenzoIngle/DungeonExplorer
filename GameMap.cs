...
namespace DungeonExplorer
{
    public class GameMap
    {
        ...
        private Monster[] monsterList = { null, new Monster("Lvl 1 Goblin", 20, 5), new Monster("Lvl 2 Goblin", 25, 5), new Monster("Lvl 1 Orc", 40, 10), new Monster("Lvl 2 Orc", 50, 10), new Monster("Troll", 80, 20), new Monster("Dragon", 120, 30) };
        public int itemNum;
        public int itemNum2;
        public int buffer = 0;
